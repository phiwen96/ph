...
Iterator.pcm: Iterator.cpp Size.pcm Constant.pcm Reference.pcm
	$(CC) $(FLAGS) -fmodule-file=Size.pcm -fmodule-file=Constant.pcm -fmodule-file=Reference.pcm -c $< -Xclang -emit-module-interface -o $@
